...
public class DocumentStoreIndexer implements Closeable{
    ...
    public void reindex() throws CommitFailedException, IOException {
        ...
        NodeStateEntryProvider nsep =
                new NodeStateEntryProvider(rootDocumentState.getRootRevision(), nodeStore, getMongoDocumentStore())
                        .withProgressReporter(this::reportDocumentRead)
                        .withPathFilter(indexer::shouldInclude);
