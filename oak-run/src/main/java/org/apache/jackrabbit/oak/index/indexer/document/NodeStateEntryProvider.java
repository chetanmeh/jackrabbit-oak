...
public class NodeStateEntryProvider implements Iterable<NodeStateEntry>, Closeable {
    ...
    public NodeStateEntryProvider(DocumentNodeStore documentNodeStore,
                                  MongoDocumentStore documentStore) {
        this(documentNodeStore.getHeadRevision(), documentNodeStore, documentStore);
    }

    public NodeStateEntryProvider(RevisionVector rootRevision, DocumentNodeStore documentNodeStore,
                                  MongoDocumentStore documentStore) {
    ...
    public NodeStateEntryProvider withProgressReporter(Consumer<String> progressReporter) {
        this.progressReporter = progressReporter;
        return this;
    }

    public NodeStateEntryProvider withPathFilter(Predicate<String> pathPredicate) {
